...
for segment in range (1100, 1300, 100): 
    ...
    for kec_angin_awal in range (1,50,1):
        for sudut in range(15,45,5):
            ...
            APIPath = R'C:/Users/febyf/Documents/TGA FEBY/SAP HASIL RUNNING/TRIPLE HOWE/API/'+str(kec_angin_mps)+'/'+str(sudut)+'/'+str(panjang)
            csvPath = R'C:/Users/febyf/Documents/TGA FEBY/SAP HASIL RUNNING/TRIPLE HOWE/API/'
            ...
            nodes.append([(4*panjang/N_batang_bawah), 0, (8*tinggi/N_batang_bawah)])

            nodes.append([(5*panjang/N_batang_bawah), 0, 0])
            nodes.append([(5*panjang/N_batang_bawah), 0, (6*tinggi/N_batang_bawah)])

            nodes.append([(6*panjang/N_batang_bawah), 0, 0])
            nodes.append([(6*panjang/N_batang_bawah), 0, (4*tinggi/N_batang_bawah)])

            nodes.append([(7*panjang/N_batang_bawah), 0, 0])
            nodes.append([(7*panjang/N_batang_bawah), 0, (2*tinggi/N_batang_bawah)])

            nodes.append([(8*panjang/N_batang_bawah), 0, 0])
            ...
            ret = PointObj.SetRestraint('16', Restraint)
            ...
            #add area object
            x = [0,(4*panjang/N_batang_bawah),(4*panjang/N_batang_bawah),0]
            y = [0,0,jarak_kuda_kuda,jarak_kuda_kuda]
            z = [0,(8*tinggi/N_batang_bawah),(8*tinggi/N_batang_bawah),0]
            Name = '1'
            UserName = ''
            ...
            x = [(4*panjang/N_batang_bawah),(8*panjang/N_batang_bawah),(8*panjang/N_batang_bawah),(4*panjang/N_batang_bawah)]
            y = [0,0,jarak_kuda_kuda,jarak_kuda_kuda]
            z = [(8*tinggi/N_batang_bawah),0,0,(8*tinggi/N_batang_bawah)]
            Name = '2'
            UserName = ''
