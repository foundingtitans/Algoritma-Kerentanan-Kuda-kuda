...
for segment in range (1100, 1300, 100): 
    ...
    for kec_angin_awal in range (1,50,1):
        for sudut in range(15,45,5):
            ...
            APIPath = R'C:/Users/febyf/Documents/TGA FEBY/SAP HASIL RUNNING/DOUBLE FINK/API/'+str(kec_angin_mps)+'/'+str(sudut)+'/'+str(panjang)
            csvPath = R'C:/Users/febyf/Documents/TGA FEBY/SAP HASIL RUNNING/DOUBLE FINK/CSV/'
            ...
            nodes=[]
            nodes.append([0, 0, 0])
            nodes.append([(0.5*panjang/N_batang_bawah), 0, (tinggi/N_batang_bawah)])
            nodes.append([(panjang/N_batang_bawah), 0, 0])
            nodes.append([(1.5*panjang/N_batang_bawah), 0, (3*tinggi/N_batang_bawah)])
            nodes.append([(2*panjang/N_batang_bawah), 0, 0])
            nodes.append([(2.5*panjang/N_batang_bawah), 0, (5*tinggi/N_batang_bawah)])
            nodes.append([(3*panjang/N_batang_bawah), 0, 0])
            nodes.append([(3.5*panjang/N_batang_bawah), 0, (3*tinggi/N_batang_bawah)])
            nodes.append([(4*panjang/N_batang_bawah), 0, 0])
            nodes.append([(4.5*panjang/N_batang_bawah), 0, (tinggi/N_batang_bawah)])
            ...
            x = [panjang,0.5*panjang,0.5*panjang,panjang]
            y = [0,0,jarak_kuda_kuda,jarak_kuda_kuda]
            z = [0,tinggi,tinggi,0]
            Name = '2'
            UserName = ''
