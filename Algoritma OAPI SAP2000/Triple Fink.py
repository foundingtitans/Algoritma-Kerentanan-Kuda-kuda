...
for segment in range (1100, 1300, 100): 
    ...
    for kec_angin_awal in range (1,50,1):
        for sudut in range(15,45,5):
            ...
            APIPath = R'C:/Users/febyf/Documents/SAP 25 TES/TRIPLE FINK/API/'+str(kec_angin_mps)+'/'+str(sudut)+'/'+str(panjang)
            csvPath = R'C:/Users/febyf/Documents/SAP 25 TES/TRIPLE FINK/CSV/'
            ...
            nodes.append([((7/2)*panjang/N_batang_bawah), 0, (7*tinggi/N_batang_bawah)])
            nodes.append([4*(panjang/N_batang_bawah), 0, 0])
            nodes.append([((9/2)*panjang/N_batang_bawah), 0, (5*tinggi/N_batang_bawah)])
            nodes.append([5*(panjang/N_batang_bawah), 0, 0])
            nodes.append([((11/2)*panjang/N_batang_bawah), 0, (3*tinggi/N_batang_bawah)])
            nodes.append([6*(panjang/N_batang_bawah), 0, 0])
            nodes.append([((13/2)*panjang/N_batang_bawah), 0, (tinggi/N_batang_bawah)])
            ...
            ret = PointObj.SetRestraint('15', Restraint)
            ...
            #add area object
            x = [0,((7/2)*panjang/N_batang_bawah),((7/2)*panjang/N_batang_bawah),0]
            ...
            x = [panjang,((7/2)*panjang/N_batang_bawah),((7/2)*panjang/N_batang_bawah),panjang]
            y = [0,0,jarak_kuda_kuda,jarak_kuda_kuda]
            z = [0,tinggi,tinggi,0]
            Name = '2'
            UserName = ''
