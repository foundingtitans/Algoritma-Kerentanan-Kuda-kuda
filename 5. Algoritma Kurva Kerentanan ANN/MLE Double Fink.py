...
data = pd.read_csv("C:/Users/febyf/Documents/TGA FEBY/SAP HASIL RUNNING/ANN Double Fink Baru")
...
data.to_csv('C:/Users/febyf/Documents/TGA FEBY/MLE/EXCEL/Setelah ANN/CDF Double Fink.csv', index = None)
