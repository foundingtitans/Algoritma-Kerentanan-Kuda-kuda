...
data = pd.read_csv("C:/Users/febyf/Documents/TGA FEBY/SAP HASIL RUNNING/ANN Double Howe Baru")
df = data.drop('Unnamed: 0', axis=1)
df['Aman Terhadap Penampang'] = df['Aman Terhadap Penampang'].replace({'[[0]]': 'AMAN', '[[1]]': 'TIDAK AMAN'})
...
data.to_csv('C:/Users/febyf/Documents/TGA FEBY/MLE/EXCEL/Setelah ANN/CDF Double Howe.csv', index = None)
